                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            for ($i = $start_index; $i < $end_index && $i < $total_products; $i++) {
                                //測試用
                            ...
                            ?>
                                ...
                                <div class="col-md-4">
                                    <div class="card mb-4 product-wap rounded-0">
                                        <div class="card rounded-0">
                                            ...
                                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                                <ul class="list-unstyled">
                                                    <span id="favorite-btn-1" data-product-id="<?= $i ?>" data-favorite="false">
                                        ...
                                        <div class="card-body">
                                            <a href="shop-single.php" class="h3 text-decoration-none"><?= $product_name ?></a>
                                            ...
                                            <p class="text-center mb-0">$<?= $product_price ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php
