    ...
    ?>
        ...
        <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
            <ol class="carousel-indicators">
                ...
                <?php
                //echo ("<li data-bs-target=\"#template-mo-zay-hero-carousel\" data-bs-slide-to=\"$i\"></li>")
                ?>
            </ol>
           ...
           /* echo ("<div class=\"carousel-item\">\n");
            ...
            echo ("<img class=\"img-fluid\" src=\"./assets/img/banner_img_01.jpg\" alt=\"\">");
            echo ("</div>");
            echo ("<div class=\"col-lg-6 mb-0 d-flex align-items-center\">");
            echo ("<div class=\"text-align-left align-self-center\">");
            echo ("<h1 class=\"h1 text-success\"><b>Zay</b> eCommerce</h1>");
            echo ("<h3 class=\"h2\">Tiny and Perfect eCommerce Template</h3>");
            echo ("<p>");
            echo ("Zay Shop is an eCommerce HTML5 CSS template with latest version of Bootstrap 5 (beta 1). 
                                    This template is 100% free provided by$i");
